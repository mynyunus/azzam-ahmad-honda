const WHATSAPP_NUMBER = "60137707438";
...
const SALES_METRICS = [
  {
    ...
    value: "18 Tahun",
    label: "Bersama Honda",
    note: "Fokus bantu pelanggan memiliki Honda",
  },
  {
    icon: "timeline",
    value: "25 Tahun",
    label: "Pengalaman Automotif",
    note: "Pengalaman luas dalam industri automotif",
  },
  {
    icon: "location_on",
    value: "Johor Bahru",
    label: "Kawasan Servis Utama",
    note: "Servis utama di sekitar Johor Bahru",
  },
];
...
const GALLERY_IMAGES = [
  "assets/gallery/WhatsApp Image 2026-02-28 at 9.06.44 PM.jpeg",
  "assets/gallery/WhatsApp Image 2026-02-28 at 9.06.45 PM (1).jpeg",
  "assets/gallery/WhatsApp Image 2026-02-28 at 9.06.45 PM (2).jpeg",
  "assets/gallery/WhatsApp Image 2026-02-28 at 9.06.45 PM (3).jpeg",
  "assets/gallery/WhatsApp Image 2026-02-28 at 9.06.45 PM.jpeg",
...
const models = [
  {
    ...
    price: "Semak harga & promosi terkini di WhatsApp",
    badge: "Top Seller",
...
function buildModelMessage(modelName) {
  return `Hi Azam Ahmad, saya berminat dengan Honda ${modelName}. Boleh bantu semak harga terkini, ready stock, dan kelayakan loan saya?`;
}
...
function renderModelCards() {
  ...
  models.forEach((model) => {
    ...
    priceCta.textContent = "Semak Harga";
...
function setupLoanCalculator() {
  ...
  const sendEstimate = () => {
    ...
    const messageLines = [
      "Hi Azam Ahmad, saya nak semak anggaran loan Honda ini:",
...
function setupQualifierForm() {
  ...
  const sendQualifier = () => {
    ...
    const messageLines = [
      "Hi Azam Ahmad, saya nak semak kelayakan dan offer Honda.",
      "",
